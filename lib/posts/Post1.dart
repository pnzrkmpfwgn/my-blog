...
class MobileViewPost1 extends StatefulWidget {
  const MobileViewPost1({Key? key}) : super(key: key);

  @override
  _MobileViewPost1State createState() {
    return _MobileViewPost1State();
  }
}

class _MobileViewPost1State extends State<MobileViewPost1> with TickerProviderStateMixin {
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: const Text("   The ultimate answer, for the ultimate question, 42. Adams Douglas, introduces this concept in his book The Hitchhiker's Guide to the Galaxy in a BBC News report. A caveman scrabbles stones: \"What do you get if you multiply six by nine?\", Arthur:\"Six by nine? Forty-two? You know, I have always felt that there was something fundamentally wrong with the Universe.\" A faint and distant voice then says: \"Base thirteen!\""
                                          ...
                                          "In Eastern religions such as Hinduism and Buddhism, many believe that a person reaches Nirvana or Moksha at the age of  42, the final goal of the life.\n\n"
                                          ...
                                          "In conclusion, these are all bunch of nonsense. Even Adam Douglas reveals that it was supposed to be a joke. Mathematical and physical conveniences can only make sense in context of human science and perspective which doesn't say much. And do not get me started on the religious staff. Therefore, here is the ultimate answer...\n\n"
                                          "Life is meaningless. Unfortunately it is that an enrolling cliche answer. No matter which way you put it, the life will end up either in a suffering or a boring ending. It is so repetitive that you will start to wonder, why did not I just blow my brain out.\n\n"
                                          ...
                                          "So what is the point then? the point is X. X is an arbitrary value with solution set of everything. Anything that you can assign to it. X is still unknown until you give it a value, a choice, your life's purpose. Despite how bad it might end up, it is your privilege to choose. All these algebra and complex computations and it takes only an X to explain everything is it not. Because simple things can be life's purpose as well. Just like Diogenes you can just shake everything off and live simply with your own terms not with anybody's nonsense. You do not have to conform, You do not have to obey, You are free to choose and sadly many of us just cannot see it.\n\n"
...
class _Post1State extends State<Post1> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:screenWidth < 1025 ? const MobileViewPost1() : LayoutBuilder(
        builder: (context,constrains)=> SingleChildScrollView(
            child:ConstrainedBox(
                constraints: BoxConstraints(
                  minHeight: constrains.minHeight,
