...
class MobileViewPost1 extends StatefulWidget {
  ...
  _MobileViewPost1State createState() {
    return new _MobileViewPost1State();
  }
}
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text("   The ultimate answer, for the ultimate question, 42. Adams Douglas, introduces this concept in his book The Hitchhiker's Guide to the Galaxy in a BBC News report. A caveman scrabbles stones: \"What do you get if you multiply six by nine?\", Arthur:\"Six by nine? Forty-two? You know, I have always felt that there was something fundamentally wrong with the Universe.\" A faint and distant voice then says: \"Base thirteen!\""
...
class _Post1State extends State<Post1> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:screenWidth < 1025 ? MobileViewPost1() : LayoutBuilder(
        builder: (context,constrains)=> SingleChildScrollView(
            child:ConstrainedBox(
                constraints: BoxConstraints(
                  minHeight: constrains.minHeight,
